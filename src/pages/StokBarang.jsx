              ...
              {activeStockOpnameSession ? (
                <>
                  ...
                  <p className="mt-1 text-xs font-bold text-slate-400">
                    Kategori: {activeStockOpnameSession.categories?.join(", ") || "-"}
                  </p>
...
function ModalWrapper({ children, maxWidth = "max-w-3xl", tall = false }) {
  return (
...
function ModalHeader({ eyebrow, title, description, color, onClose }) {
  const colorClass = {
    blue: "text-blue-600",
    emerald: "text-emerald-600",
  }
